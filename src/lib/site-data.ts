...
export const insights = [
  { category: "Corporate", title: "Five Legal Considerations Before Expanding Your UAE Business", excerpt: "Expansion creates opportunity, but structure, authority, contracts, and compliance should move at the same pace.", read: "6 min read" },
  { category: "Contracts", title: "Why Commercial Contracts Should Be Reviewed Before Renewal", excerpt: "A familiar contract can still carry outdated risks, unclear obligations, and terms that no longer fit the relationship.", read: "4 min read" },
  { category: "Compliance", title: "Building a Practical Legal Risk Framework for Growing Companies", excerpt: "A useful legal risk framework gives management visibility without turning every decision into a legal exercise.", read: "7 min read" },
  { category: "Employment", title: "Executive Employment Agreements: Clauses That Deserve Closer Attention", excerpt: "Senior appointments require precision around authority, incentives, confidentiality, termination, and post-employment duties.", read: "5 min read" },
  { category: "Disputes", title: "When Early Legal Assessment Changes the Direction of a Dispute", excerpt: "The right assessment at the beginning can preserve evidence, improve leverage, and avoid expensive procedural mistakes.", read: "6 min read" },
  { category: "Business Setup", title: "Mainland or Free Zone: Looking Beyond the Initial Setup", excerpt: "The right structure should reflect where the company will operate, contract, hire, grow, and raise capital.", read: "5 min read" },
];
